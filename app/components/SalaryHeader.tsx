...
export default function SalaryHeader({ total }: { total: number }) {
  return (
    <div className="bg-green-600 rounded-xl p-6 text-center relative flex flex-col items-center sm:items-start sm:text-left">
      ...
      {/* Logotipas */}
      <div className="mb-4 sm:mb-0 sm:absolute sm:top-4 sm:left-4 w-24 h-24 sm:w-36 sm:h-36">
        <Image
          src="/logoss.png"
          alt="Logo"
          width={150}
      ...
      {/* Tekstas */}
      <div className="sm:ml-40"> {/* atitraukiam tekstą, kad nesidengtų su absolute logotipu */}
